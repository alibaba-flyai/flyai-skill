...
4. **Read command details BEFORE calling**: each command has its own schema — always check the corresponding file in `references/` before invoking any command. Do NOT guess or reuse formats from other commands.
